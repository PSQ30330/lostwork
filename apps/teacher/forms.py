...
class UserForm(forms.Form):
    username = forms.CharField(label="工号", max_length=15, widget=forms.TextInput(attrs={'class': 'form-control'}))
...
class RegisterForm(forms.Form):
    ...
    username = forms.CharField(label="工号", max_length=15, widget=forms.TextInput(attrs={'class': 'form-control'}))
    tea_name = forms.CharField(label='姓名',max_length=32, widget=forms.TextInput(attrs={'class': 'form-control'}))
